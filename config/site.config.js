...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'edurtw@ehmso.eu.org',
  ...
  email: 'mailto:eduroamtw@googlegroups.com',
  ...
  links: [
    {
      name: 'Main Page',
      link: 'https://edur.isli.me/',
    },
    {
      name: 'GitHub',
      link: 'https://github.com/eduroamtw/',
    },
  ],
